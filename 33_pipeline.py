...
Original file is located at
    https://colab.research.google.com/drive/1TjZ_jvA55WKkUL9xs5C3p-5Dad2CtNuk
"""
...
def pipeline_model(path):
    ...
    faceDetectionModel = '/content/drive/MyDrive/test_cv/models/res10_300x300_ssd_iter_140000_fp16.caffemodel';

    # Mô tả kiến trúc
    faceDetectionProto = '/content/drive/MyDrive/test_cv/models/deploy.prototxt.txt.prototxt'

    # Mô hình mô tả khuôn mặt
    faceDescriptor = '/content/drive/MyDrive/test_cv/models/openface.nn4.small2.v1.t7'
    ...
    # face recognition
    face_recognition_model = pickle.load(open('/content/drive/MyDrive/test_cv/ml_face_person_identity.pkl',
                                            mode='rb'))
    # pipeline model
    img = cv2.imread(path)
    image = img.copy()
...
img, results = pipeline_model('/content/drive/MyDrive/test_cv/FaceImage/162000989_NguyenThanhSang/image_840.jpg')
cv2_imshow(img)
